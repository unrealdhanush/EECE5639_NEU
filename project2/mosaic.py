...
def main():
    path = "/Users/dhanush/Northeastern/2023spring/eece5639/project2/DanaHallWay1"
    #path = "/Users/dhanush/Northeastern/2023spring/eece5639/project2/DanaOffice"

    imgset = []
    for sno in os.listdir(path + '/'):
        imgset.append(cv2.cvtColor(cv2.imread(path + '/' + sno), cv2.COLOR_BGR2RGB))
